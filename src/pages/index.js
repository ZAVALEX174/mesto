...
const userInfo = new UserInfo({name: userInfoName, about: userInfoJob, avatar: userInfoAvatar});
...
function handleSubmitFormProfileEdit(evt) {
    ...
    api.setUserProfile(popupFormUserInfo.formValues)
        .then((data) => {
...
function handleSubmitFormAvatarEdit(evt) {
    ...
    api.setAvatar(popupAvatarEditForm.formValues)
        .then((data) => {
            userInfo.setUserInfo(data);
...
const popupConfirmation = new PopupWithConfirmation('.popup_confirm', (card) => {
